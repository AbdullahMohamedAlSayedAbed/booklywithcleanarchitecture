...
class ServerFailure extends Failure {
  ...
  factory ServerFailure.fromDioException(DioException e){
    switch(e.type){
      ...
      return ServerFailure("Response receive timeout. Please try again later.");
      case DioExceptionType.badCertificate:
      return ServerFailure("bad Certificate with api server Please try again later.");
      ...
      return ServerFailure("No internet connection,please try connect to internet");
