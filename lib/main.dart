...
import 'package:booklywithcleanarchitecture/core/utils/hive_services.dart';
...
void main() async {
  ...
  hiveService.registerAdapter<BookEntity>(BookEntityAdapter());

  await Future.wait([
    hiveService.openBox<BookEntity>(kFeaturedBook),
    hiveService.openBox<BookEntity>(kNewestBook),
  ]);
